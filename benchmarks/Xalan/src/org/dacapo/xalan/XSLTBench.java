...
public class XSLTBench {
	...
	public static int index = 2; // 10.4, 7.4, 5.8
	public static int[] quality = { 58, 74, 104 };
		...
		public void run() {
			try {
				...
				while (true) {
					...
					if (fileName.equals(""))
						break;
					Transformer transformer = pattern[index].newTransformer();
					...
					finished += quality[index];
					// check battery status and make decision
					todo = _workQueue.size() * quality[index];
	...
	public static void main(String[] args) throws Exception {
		...
		XSLTBench bench = new XSLTBench(scratch);
