...
public class Scene {
    ...
    private mcase<int> imageWidth = mcase<int> {
      low: 480;
      mid: 800;
      high: 1024
    };

    private mcase<int> imageHeight = mcase<int> {
      low: 320;
      mid: 600;
      high: 728
    };
    ...
    public void render(Options options, ImageSampler sampler, Display display) {
        ...
        int imageWidthTemp = MathUtils.clamp(imageWidth, 1, 1 << 14);
        int imageHeightTemp = MathUtils.clamp(imageHeight, 1, 1 << 14);
        ...
        sampler.prepare(options, this, imageWidthTemp, imageHeightTemp);
