...
%{
    ...
    protected void init_keywords() {
        ...
        keywords.put("modes",		  	  new Integer(sym.MODES));
  		  ...
  		  keywords.put("bsupply",      	new Integer(sym.BSUPPLY));
  		  keywords.put("tsupply",      	new Integer(sym.TSUPPLY));
  		  keywords.put("battery",      	new Integer(sym.BATTERY));
  		  keywords.put("temperature",   new Integer(sym.TEMPERATURE));
  		  keywords.put("demand",      	new Integer(sym.DEMAND));
